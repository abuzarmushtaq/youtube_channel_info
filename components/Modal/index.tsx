...
export const Modal = ({ open, onClose }: Props) => {
  ...
  const url = `https://accounts.google.com/o/oauth2/auth?client_id=${clientId}&redirect_uri=https://testing-vercel-one.vercel.app/auth/callback&scope=${scope}&response_type=token`
